<?php
    ...
    $delete = $pdo->prepare("DELETE FROM user WHERE user_id=".$id);
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($_POST['username'])){
            ...
            if($select->rowCount() > 0 ){
                ...
                //insert query here
                $insert = $pdo->prepare("INSERT INTO user(username,fullname,password,role,is_active) VALUES(:name,:fullname,:pass,:role,1)");
                ...
                if($insert->execute()){
                    echo'<script type="text/javascript">
                        jQuery(function validation(){
                        swal("Success", "User Inserted Successfully", "success", {
                        button: "Continue",
                            });
                        });
                        </script>';

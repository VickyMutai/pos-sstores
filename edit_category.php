<?php
  ...
  if(isset($_POST['btn_edit'])){
      ...
      $update = $pdo->prepare("UPDATE category SET category_name='$category_name' WHERE category_id='".$_GET['id']."' ");
  ...
  if($id=$_GET['id']){
    $select = $pdo->prepare("SELECT * FROM category WHERE category_id = '".$_GET['id']."' ");
    $select->execute();

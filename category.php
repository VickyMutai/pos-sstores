<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if(isset($_POST['category'])){
      ...
      $select = $pdo->prepare("SELECT category_name FROM category WHERE category_name='$category'");
      $select->execute();
      ...
      if($select->rowCount() > 0 ){
          echo'<script type="text/javascript">
            ...
            $insert = $pdo->prepare("INSERT INTO category(category_name) VALUES(:category)");

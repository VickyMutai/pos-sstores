   ...
   if($_SESSION['username']==""){
    ...
    if(isset($_POST['save_order'])){
      ...
      if($arr_product_code == ""){
        ...
        $insert = $pdo->prepare("INSERT INTO invoice(cashier_name, order_date, time_order, total, paid, due)
        ...
        if($invoice_id!=null){
          for($i=0; $i<count($arr_product_id); $i++){
            ...
            if($rem_qty<0){
              ...
              $update = $pdo->prepare("UPDATE product SET stock = '$rem_qty' WHERE product_id='".$arr_product_id[$i]."'");
              $update->execute();
            }
        ...
        $('.productid').on('change', function(e){
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              tr.find(".clientname").val(data["client_name"]);

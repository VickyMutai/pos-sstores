            ...
            <div class="box-body">
              <div class="row">
                ...
                <br>
                  ...
                  <?php
                    $select = $pdo->prepare("SELECT sum(total) as total, count(invoice_id) as invoice FROM invoice
              ...
              <!-- Transaction Graphic -->
              <?php
                  $select = $pdo->prepare("SELECT order_date, sum(total) as price FROM invoice WHERE order_date BETWEEN :fromdate AND :todate
                  GROUP BY order_date");
                  $select->bindParam(':fromdate', $_POST['date_1']);
                  $select->bindParam(':todate', $_POST['date_2']);
                  $select->execute();
              ...
              <?php
                  $select = $pdo->prepare("SELECT product_name, sum(qty) as q FROM invoice_detail WHERE order_date BETWEEN :fromdate AND :todate
                  GROUP BY product_id");
                  $select->bindParam(':fromdate', $_POST['date_1']);
                  $select->bindParam(':todate', $_POST['date_2']);
                  $select->execute();
